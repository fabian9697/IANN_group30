% Koma-Skript Vorlage für Artikel
\documentclass[
    pdftex,
    a4paper,
    oneside,
...
% Paket für Rechtschreibung und Quotes
...
% Einige unübliche Trennungen
\hyphenation
{Ur-instinkt }

% Definieren des Titels
\title{Titel}
\author{Fabian Imkenberg, Jacqueline Näther}
\date{\today}

% Einfügen des Titels
\maketitle

%Abstract wird voerst nicht benötigt
%\begin{abstract}
...
% Ab hier werden alle Abschnitte als Anhänge betrachtet.
\appendix
